...
@section('heading', 'New Team')

@section('content')
    <div class="max-w-lg">
        <form method="POST" action="{{ route('teams.store') }}" class="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
            @csrf
            ...
            <div>
                ...
                <input type="text" id="ad_group" name="ad_group" value="{{ old('ad_group') }}"
            ...
            <div class="flex items-center gap-3 pt-2">
                ...
                <a href="{{ route('teams.index') }}" class="text-sm text-gray-500 hover:text-gray-700">Cancel</a>
            </div>
        </form>
    </div>
@endsection
